...
def learning_effect_loss(post_test_scores):
    # 预测学习效果
    # 计算有效性（仅当前时间步）
    ...
    # batch_gain = metric.compute_effectiveness_tensor(original_seqs,
    ...
    actual_score_gain = torch.zeros_like(predicted_score_gain)
